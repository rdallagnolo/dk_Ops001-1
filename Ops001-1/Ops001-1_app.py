...
# calendar 
d=st.sidebar.date_input(label="",value=datetime.date(2021,10,25))     # starting date
...
st.markdown(f"<h2 style='text-align: center; color: white '>{d} ({wd})</h2>", unsafe_allow_html=True)
